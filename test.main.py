...
print("#-------------------------------------#")
print("#          Testing Hash-dict          #")
print("#-------------------------------------#")
t_ok = 0
for i in range(1, 15):
    if i < 10:
        os.system("python main.py -hash pubInst/00" + str(i) + ".txt > output.txt.sol")
        output = open("output.txt.sol", "r")
        sol = open("pubInst/00" + str(i) + ".txt.sol", "r")
    else:
        os.system("python main.py -hash pubInst/0" + str(i) + ".txt > output.txt.sol")
        output = open("output.txt.sol", "r")
        sol = open("pubInst/0" + str(i) + ".txt.sol", "r")
    out_line = []
    sol_line = []
